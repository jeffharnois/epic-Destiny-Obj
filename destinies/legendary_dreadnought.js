{
    ...
    "autogrants": [
        {
            "abil_name": "Shrug Off Punishment",
            "img": "shrugoffpunishment",
            "abil": "+10 Max Health per level of Legendary Dreadnought (including this one).",
            "passive": "passive"
        },
        {
            "abil_name": "Action Hero",
            "img": "actionhero",
            "abil": "(level 1) Reduces the cooldowns of your Action Boost abilities by 33%.",
            "passive": "passive"
        },
        {
            "abil_name": "Unstoppable",
            "img": "unstoppable",
            "abil": "(level 2) (Cooldown: 3 mins) Activate to remove all Crowd Control effects currently restraining you. This ability can be used while helpless.",
            "passive": false
        },
        {
            "abil_name": "Action Boost: Unmovable",
            "img": "unmovable",
            "abil": "(level 3) (Cooldown: 2 mins 15 secs) Activate to gain a +20 Action Boost bonus to to Fortitude and Balance saves for 60 seconds. This ability can be used while helpless.",
            "passive": false
        },
        {
            "abil_name": "Action Boost: Thick Skinned",
            "img": "thickskinned",
            "abil": "(level 4) (Cooldown: 3 mins) Activate to take 25% less damage from all sources for 30 seconds. This ability can be used while helpless.",
            "passive": false
        },
        {
            "abil_name": "Combat Brute",
            "img": "combatbrute",
            "abil": "(level 5) You gain +1[W] damage with melee weapons and deal +50% damage to helpless opponents while any Action Boost is active.",
            "passive": "passive"
        }
    ],
    "1a": {
        "abil_name": "Sundering swing",
        "required_by": null,
        "required": 0,
        "prereq": null,
        "selected": 0,
    ...
    "1b": {
        "abil_name": "Legendary Tactics",
        "required_by": null,
        "required": 0,
        "prereq": null,
        "selected": 0,
        "img": "legendarytactics",
        "multi": false,
        "passive": "passive",
        "ranks": 3,
        "AP": 1,
    ...
    "1c": {
        "abil_name": "Extra Action Boost",
        "required_by": null,
        "required": 0,
        "prereq": null,
        "selected": 0,
        "img": "extraactionboost",
        "multi": false,
        "passive": "passive",
        "ranks": 3,
        "AP": 1,
    ...
    "1d": {
        "abil_name": "Action Boost: Attack",
        "required_by": null,
        "required": 0,
        "prereq": null,
        "selected": 0,
        "img": "actionboost_attack",
        "multi": false,
        "passive": false,
        "ranks": 3,
        "AP": 1,
    ...
    "2b": {
        "abil_name": "Improved Combat Expertise",
        "required_by": null,
        "required": 4,
        "prereq": null,
        "selected": 0,
        "img": "improvedcombatexpertise",
        "multi": false,
        "passive": "passive",
        "ranks": 1,
        "AP": 2,
    ...
    "2c": {
        "abil_name": "Improved Power Attack",
        "required_by": null,
        "required": 4,
        "prereq": null,
        "selected": 0,
        "img": "improvedpowerattack",
        "multi": false,
        "passive": "passive",
        "ranks": 1,
        "AP": 2,
    ...
    "2d": {
        "abil_name": "Action Boost: Damage",
        "required_by": null,
        "required": 4,
        "prereq": null,
        "selected": 0,
        "img": "actionboost_damage",
        "multi": false,
        "passive": false,
        "ranks": 3,
        "AP": 1,
    ...
    "3c": null,
    "3d": {
        "abil_name": "Action Boost: Haste",
        "required_by": null,
        "required": 8,
        "prereq": null,
        "selected": 0,
        "img": "actionboost_haste",
        "multi": false,
        "passive": false,
        "ranks": 3,
        "AP": 1,
    ...
    "4b": {
        "abil_name": "Volcano&rsquo;s Edge",
        "required_by": null,
        "required": 12,
        "prereq": null,
        "selected": 0,
    ...
    "5c": null,
    "5d": {
        "abil_name": "Devastating Critical",
        "required_by": [
            "6d"
        ],
        "required": 16,
    ...
    "6a": {
        "abil_name": "Master&rsquo;s blitz",
        "required_by": null,
        "required": 20,
        "prereq": null,
        "selected": 0,
    ...
    "6d": {
        "abil_name": "Headman&rsquo;s Chop",
        "required_by": null,
        "required": 20,
        "prereq": "5d",
        "selected": 0,

{
  ...
  "1c": {"abil_name": "Extra Action Boost", "required": 0, "prereq": null, "selected": 0, "img":"extraactionboost", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2c": {"abil_name": "Improved Power Attack", "required": 4, "prereq": null, "selected": 0, "img":"improvedpowerattack", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "4a": {"abil_name": "Tactical Genius", "required": 12, "prereq": null, "selected": 0, "img":"tacticalgenius", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "5a": {"abil_name": "Advancing Blows", "required": 16, "prereq": null, "selected": 0, "img":"advancingblows", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": "On melee critical hit, you gain: +1 to hit and damage for 6 seconds. Stacks 5 times."
    }
  },
  "5b": null,
  "5c": null,
  "5d": {"abil_name": "Devastating Critical", "required": 16, "prereq": null, "selected": 0, "img":"devastatingcritical", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "6a": {"abil_name": "Master&rsquo;s blitz", "required": 20, "prereq": null, "selected": 0, "img":"mastersblitz", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {

{
  ...
  "1b": {"abil_name": "Wild Shots", "required": 0, "prereq": null, "selected": 0, "img":"wildstrikes", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Healing Spring", "required": 0, "prereq": null, "selected": 0, "img":"healingspring", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1d": {"abil_name": "Illusion of Well Being", "required": 0, "prereq": [{"req": "1c", "tier": 1}], "selected": 0, "img":"illusionofwellbeing", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2a": {"abil_name": "Prism", "required": 4, "prereq": null, "selected": 0, "img":"prism", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "2b": {"abil_name": "Pin", "required": 4, "prereq": null, "selected": 0, "img":"pin", "multi": false, "passive": false, "ranks": 2, "AP": 1, "abil": {
  ...
  "2c": {"abil_name": "Fey Spring", "required": 4, "prereq": [{"req":"1c","tier": 1}], "selected": 0, "img":"feyspring", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2d": {"abil_name": "Fey Form", "required": 4, "prereq": [{"req":"2c","tier": 1}], "selected": 0, "img":"feyform", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "Gain DR 3/Cold Iron and +5 Spell Power.",
      "2": "Gain DR 5/Cold Iron and +10 Spell Power.",
      "3": "Gain DR 7/Cold Iron and +15 Spell Power."
    }
  },
 "2e": {"abil_name": "Dexterity or Wisdom", "required": 4, "prereq": null, "selected": 0, "img":"dexwis", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Wisdom"}
    }
  },
  "3a": {"abil_name": "Rainbow", "required": 8, "prereq": [{"req":"2a","tier": 1}], "selected": 0, "img":"rainbow", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "3b": {"abil_name": "Otto&rsquo;s Whistler", "required": 8, "prereq": null, "selected": 0, "img":"ottoswhistler", "multi": false, "passive": false, "ranks": 2, "AP": 1, "abil": {
  ...
  "3c": {"abil_name": "Whirling Wrist", "required": 8, "prereq": null, "selected": 0, "img":"throwndoublestrike", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3d": null,
  "3e": {"abil_name": "Dexterity or Wisdom", "required": 8, "prereq": null, "selected": 0, "img":"dexwis", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Wisdom"}
    }
  },
  "4a": {"abil_name": "Double Rainbow", "required": 12, "prereq": [{"req":"3a","tier":1}], "selected": 0, "img":"doublerainbow", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "4b": {"abil_name": "Stay Good ", "required": 12, "prereq": null, "selected": 0, "img":"staygood", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "4c": {"abil_name": "In the Weeds", "required": 12, "prereq": null, "selected": 0, "img":"intheweeds", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4d": {"abil_name": "Elemental Absorption", "required": 12, "prereq": [{"req":"2d","tier":1}], "selected": 0, "img":"elementalabsorption", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "4e": {"abil_name": "Dexterity or Wisdom", "required": 12, "prereq": null, "selected": 0, "img":"dexwis", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Wisdom"}
    }
  },
  "5a": {"abil_name": "Track", "required": 16, "prereq": null, "selected": 0, "img":"track", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "Ranged attacks reduce enemy AC by -1 for 20 seconds. This effect stacks up to 3 times",
      "2": "",
      "3": ""
    }
  },
  "5b": {"abil_name": "Stand and Deliver", "required": 16, "prereq": null, "selected": 0, "img":"standanddeliver", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": "While standing still you gain +1 competence bonus to ranged damage and +1% spell power every few seconds, up to +10"
    }
  },
  "5c": null,
  "5d": {"abil_name": "Nerve toxin", "required": 16, "prereq": null, "selected": 0, "img":"nervetoxin", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "5e": {"abil_name": "Dexterity or Wisdom", "required": 16, "prereq": null, "selected": 0, "img":"dexwis", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Wisdom"}
    }
  },
  "6a": null,
  "6b": {"abil_name": "Audience With The Queen", "required": 20, "prereq": null, "selected": 0, "img":"audiencewiththequeen", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6c": {"abil_name": "Rain of Arrows", "required": 20, "prereq": null, "selected": 0, "img":"rainofarrows", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6d": null,
  "6e": {"abil_name": "Dexterity or Wisdom", "required": 20, "prereq": null, "selected": 0, "img":"dexwis", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Wisdom"}
    }
  }
}
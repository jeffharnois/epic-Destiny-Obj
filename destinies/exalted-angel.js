{
  ...
  1b: {abil_name: "Endless Faith", required: 0, prereq: [{req:"1c",tier:3},{req:"1d",tier:3}], multi: false, passive:true, ranks: 3, AP: 1, "abil": {
  ...
  1c: {abil_name: "Radiant Power", required: 0, prereq: null, multi: false, passive:true, ranks: 3, AP: 1, "abil": {
      1: "+10 Light spellpower", 
      2: "+20 Light spellpower", 
      3: "+30 Light spellpower"
    }
  },
  1d: {abil_name: "Healing Power", required: 0, prereq: null, multi: false, passive:true, ranks: 3, AP: 1, "abil": {
      1: "+10 Positive energy spellpower", 
      2: "+20 Positive energy spellpower", 
      3: "+30 Positive energy spellpower"
    }
  },
  1e: {abil_name: "Wisdom/Charisma", required: 0, prereq: null, multi: false, passive:true, ranks: 1, AP: 1, "abil": {
  ...
  2c: null,
  2d: null,
  2e: {abil_name: "Wisdom/Charisma", required: 4, prereq: null, multi: false, passive:true, ranks: 1, AP: 1, "abil": {
        1: {1: "+1 Wisdom", 2: "+1 Charisma"}
      }
    },
  ...
  3d: {abil_name: "Purity Of Essence", required: "8", prereq: [{req:1d,tier,1},{req:"3c",tier:1}], multi: false, passive:true, ranks: 3, AP: 1, "abil": {
      1: "3% healing amp", 
      2: "5% healing amp", 
      3: "10% healing amp"
    }
  },
  3e: {abil_name: "Wisdom/Charisma", required: "8", prereq: null, multi: false, passive:true, ranks: 1, AP: 1, "abil": {
        1: {1: "+1 Wisdom", 2: "+1 Charisma"}
      }
    },
  4a: {abil_name: "Judge The Many", required: "12", prereq: "Lay to rest 1", multi: false, passive:true, ranks: 1, AP: 1, "abil": {
  ...
  4c: {abil_name: "Blood And Radiance", required: "12", prereq: null, multi: false, passive:true, ranks: 3, AP: 1, "abil": {
  ...
  4d: {abil_name: "Excoriate", required: "12", prereq: "Blood and radiance 1", multi: false, passive:true, ranks: 1, AP: 2, "abil": {
      1: "When your Righteous Fervor stack is >=5, your light spells and smites have a 3% chance to stun opponents for 6 seconds", 
    }
  },
  4e: {abil_name: "Wisdom/Charisma", required: "12", prereq: null, multi: false, passive:true, ranks: 1, AP: 2, "abil": {
        1: {1: "+1 Wisdom", 2: "+1 Charisma"}
      }
    },
  ...
  5c: null,
  5d: null,
  5e: {abil_name: "Wisdom/Charisma", required: "16", prereq: null, multi: false, passive:true, ranks: 1, AP: 2, "abil": {
        1: {1: "+1 Wisdom", 2: "+1 Charisma"}
      }
    },
  6a: null,

{
  ...
  "name": "Primal Avatar",
  "autogrants": [
      {"abil_name":"Spirit of Strength", "img":"", "abil": "(5 sec cooldown) When you hit with a melee attack, or cast a spell on an ally, or cast an offensive spell on an enemy, you gain 1 Spirit. Each of these three categories triggers only once every three seconds. You can have up to 30 Spirit. Spirit decays at a rate of one every 9 seconds. Toggle: You gain +30 Universal Spell Power. Costs 1 Spirit to activate and 1 Spirit every six seconds. (Stays toggled on until manually turned off.)", "passive": false},
      {"abil_name":"Magic of Nature", "img":"", "abil": "(level 1) +50 SP per level of Primal Avatar.<br />You gain caster levels equal to your Primal Avatar level for Druid and Ranger sells, if you have any levels in those classes.", "passive": "passive"},
      {"abil_name":"Primal Travel", "img":"", "abil": "(level 2) You quickly jump backwards several times. Costs 1 Spirit.", "passive": false},
      {"abil_name":"Mighty Among Spirits", "img":"", "abil": "(level 3) 20 HP.<br />Spirit decays every 15 seconds instead of every 9 seconds.", "passive": "passive"},
      {"abil_name":"Eternal Return", "img":"", "abil": "(level 4) Toggle: While below 50% health, you gain 12 health and lose one spirit and 4 SP every two seconds. Costs 1 Spirit to activate. (Stays toggled on until manually turned off.)", "passive": false},
      {"abil_name":"Walk with the Spirits", "img":"", "abil": "(level 5) (100 SP, 1 Spirit to activate) You become invisible and ethereal to monsters, and gain +30 Hide and Move Silently. This consumes 1 Spirit each second. (Turns off if you run out of Spirit.)", "passive": false}
  ],
  "1a": {"abil_name": "Ephemeral Evolution", "required": 0, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1b": {"abil_name": "Rejuvination Cocoon", "required": 0, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Insidious Spores", "required": 0, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1d": {"abil_name": "Friends of Nature", "required": 0, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": false, "ranks": 1, "AP": 1, "abil": {
  ...
  "3a": {"abil_name": "Balanced Attacks", "required": 8, "prereq": "2a", "selected": 0, "img":"", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3b": {"abil_name": "Summer Smoke", "required": 8, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3c": {"abil_name": "Tsunami", "required": 8, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3d": {"abil_name": "The Oncoming Storm", "required": 8, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4a": {"abil_name": "Paired Parry / Symetric Strikes", "required": 12, "prereq": "3a", "selected": 0, "img":"", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "4b": {"abil_name": "Autumn Harvest", "required": 12, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4c": {"abil_name": "Stormrage", "required": 12, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4d": {"abil_name": "Summon Dryad Elder", "required": 12, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "5a": null,
  "5b": {"abil_name": "Chill of Winter", "required": 16, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "5c": {"abil_name": "Spirit Boon", "required": 16, "prereq": null, "selected": 0, "img":"", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6a": {"abil_name": "Nature\'s Fury / Natural Evasion", "required": 20, "prereq": "4a", "selected": 0, "img":"", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "6b": null,
  "6c": {"abil_name": "Avatar of Nature", "required": 20, "prereq": null, "selected": 0, "img":"", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {

{
    ...
    "autogrants": [
        {
            "abil_name": "Spirit of Strength",
            "img": "spiritofstrength",
            "abil": "(5 sec cooldown) When you hit with a melee attack, or cast a spell on an ally, or cast an offensive spell on an enemy, you gain 1 Spirit. Each of these three categories triggers only once every three seconds. You can have up to 30 Spirit. Spirit decays at a rate of one every 9 seconds. Toggle: You gain +30 Universal Spell Power. Costs 1 Spirit to activate and 1 Spirit every six seconds. (Stays toggled on until manually turned off.)",
            "passive": false
        },
        {
            "abil_name": "Magic of Nature",
            "img": "magicofnature",
            "abil": "(level 1) +50 SP per level of Primal Avatar.<br />You gain caster levels equal to your Primal Avatar level for Druid and Ranger sells, if you have any levels in those classes.",
            "passive": "passive"
        },
        {
            "abil_name": "Primal Travel",
            "img": "primaltravel",
            "abil": "(level 2) You quickly jump backwards several times. Costs 1 Spirit.",
            "passive": false
        },
        {
            "abil_name": "Mighty Among Spirits",
            "img": "mightamongspirits",
            "abil": "(level 3) 20 HP.<br />Spirit decays every 15 seconds instead of every 9 seconds.",
            "passive": "passive"
        },
        {
            "abil_name": "Eternal Return",
            "img": "eternalreturn",
            "abil": "(level 4) Toggle: While below 50% health, you gain 12 health and lose one spirit and 4 SP every two seconds. Costs 1 Spirit to activate. (Stays toggled on until manually turned off.)",
            "passive": false
        },
        {
            "abil_name": "Walk with the Spirits",
            "img": "walkwithspirits",
            "abil": "(level 5) (100 SP, 1 Spirit to activate) You become invisible and ethereal to monsters, and gain +30 Hide and Move Silently. This consumes 1 Spirit each second. (Turns off if you run out of Spirit.)",
            "passive": false
        }
    ],
    "1a": {
        "abil_name": "Ephemeral Evolution",
        "required_by": null,
        "required": 0,
        "prereq": null,
        "selected": 0,
    ...
    "4a": {
        "abil_name": "Paired Parry / Symetric Strikes",
        "required_by": [
            "6a"
        ],
        "required": 12,
        ...
        "abil": {
            "1": {
                "1": "Gain +5 AC while in animal form, unarmed, or two-weapon fighting.",
                "2": "Gain 5% physical damage while in animal form, unarmed, or two-weapon fighting."
            }
        }
    },
    "4b": {
        "abil_name": "Autumn Harvest",
        "required_by": null,
        "required": 12,
        "prereq": null,
        "selected": 0,
        ...
        "AP": 1,
        "abil": {
            "1": "When enemies die there&rsquo;s a 5% chance for all party members near that enemy to receive 10d10 positive healing. (This isn&rsquo;t effected by spellpower)",
            "2": "When enemies die there&rsquo;s a 5% chance for all party members near that enemy to receive 15d10 positive healing. (This isn&rsquo;t effected by spellpower)",
            "3": "When enemies die there&rsquo;s a 5% chance for all party members near that enemy to receive 20d10 positive healing. (This isn&rsquo;t effected by spellpower)"
        }
    },
    "4c": {
        "abil_name": "Stormrage",
    ...
    "5c": {
        ...
        "abil": {
            "1": {
                "1": "Temporarily gain +2 Primal bonus to all physical abilities (Str, Dex, Con)",
                "2": "Temporarily gain +2 Primal bonus to all mental abilities (Int, Wis, Cha)"
            }
        }
    },
    "5d": null,
    ...
    "6a": {
        "abil_name": "Nature&rsquo;s Fury / Natural Evasion",
        "required_by": null,
        "required": 20,
        "prereq": "4a",
        "selected": 0,
        ...
        "abil": {
            "1": {
                "1": "Gain +1 critical damage multiplier on a roll of 19-20 while in animal form, unarmed, or two-weapon fighting.",
                "2": "Gain Evasion while in animal form, unarmed, or two-weapon fighting."
            }
        }
    },
    "6b": null,
    "6c": {
        "abil_name": "Avatar of Nature",
        "required_by": null,
        "required": 20,
        "prereq": null,
        "selected": 0,
        ...
        "AP": 2,
        "abil": {
            "1": "You become an Avatar of Nature. Every 3 seconds, you gain +1 size, +2 strength, +2 Constitution, a large bonus to damage based on size, and lose some movement speed, stacking up to size 4.<br />Size 1+: +50 size bonus to PRR<br />Size 2+: When you attack enemies they become poisoned, taking 2d10 poison damage every 2 seconds for several seconds. This poison stacks up to 5 times.<br />Size 3+: Enemies attacking you have a chance to become diseased, dealing 1d4 Constitution damage every two seconds for 10 seconds.<br />Size 4: The ground shakes when you put your foot down. Your third attack while standing still knocks down nearby enemies and deals extra bludgeoning damage in an area.<br />This costs 1 Spirit every few seconds per size you&rsquo;ve gained (Turns off if you run out of Spirit.)"
        }
    },
    "6d": null,
    "6e": {

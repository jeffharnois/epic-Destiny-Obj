{
  ...
  "1a": {"abil_name": "Ephemeral Evolution", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"ephemeralevolution", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1b": {"abil_name": "Rejuvination Cocoon", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"rejuvenationcocoon", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Insidious Spores", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"insidiousspores", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1d": {"abil_name": "Friends of Nature", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"friendsofnature", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": {
  ...
  "1e": {"abil_name": "Strength or Wisdom", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "2b": {"abil_name": "Supple as Spring", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"suppleasspring", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2c": {"abil_name": "Favored Enemy", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"contagiousspores", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {
  ...
  "2e": {"abil_name": "Strength or Wisdom", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Strength", "2": "+1 Wisdom"}
    }
  },
  ...
  "3b": {"abil_name": "Summer Smoke", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"summersmoke", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3c": {"abil_name": "Tsunami", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"tsunami", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3d": {"abil_name": "The Oncoming Storm", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"oncomingstorm", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3e": {"abil_name": "Strength or Wisdom", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Strength", "2": "+1 Wisdom"}
    }
  },
  ...
  "4b": {"abil_name": "Autumn Harvest", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"autumnharvest", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4c": {"abil_name": "Stormrage", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"stormrage", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4d": {"abil_name": "Summon Dryad Elder", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"summondryad", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": "Summon a Dryad Elder. She uses her magic for damage spells as well as support and healing."
    }
  },
  "4e": {"abil_name": "Strength or Wisdom", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Strength", "2": "+1 Wisdom"}
    }
  },
  "5a": null,
  "5b": {"abil_name": "Chill of Winter", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"chillofwinter", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "5c": {"abil_name": "Spirit Boon", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"spiritboon", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "5d": null,
  "5e": {"abil_name": "Strength or Wisdom", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Strength", "2": "+1 Wisdom"}
    }
  },
  "6a": {"abil_name": "Nature\'s Fury / Natural Evasion", "required_by": null, "required": 20, "prereq": "4a", "selected": 0, "img":"nfne", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "6b": null,
  "6c": {"abil_name": "Avatar of Nature", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"aon", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6d": null,
  "6e": {"abil_name": "Strength or Wisdom", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Strength", "2": "+1 Wisdom"}
    }
  }
}
{
  ...
  "1c": {"abil_name": "Music of the Spider Queen", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"musicspiderqueen", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
      "1": "Fascinate can mesmerize vermin. Vermin still cannot be suggested. "
    }
  },
  "1d": {"abil_name": "Dirge", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"revielle", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1e": {"abil_name": "Charisma or Strength", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  "2a": {"abil_name": "Tailwind", "required_by": null, "required": 4, "prereq": "1a", "selected": 0, "img":"tailwind", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2b": {"abil_name": "Lucidity", "required_by": null, "required": 4, "prereq": "1b", "selected": 0, "img":"lucidity", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2c": {"abil_name": "Masked Ball", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"maskedball", "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "2d": null,
  "2e": {"abil_name": "Charisma or Strength", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  ...
  "3b": {"abil_name": "Reign", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"artfulmisdirection", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3c": {"abil_name": "Echos of the Ancestors, Arcane", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"echoesmagister", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3d": {"abil_name": "Aria", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"ventriloquism", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3e": {"abil_name": "Charisma or Strength", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  "4a": {"abil_name": "Chord of Disruption", "required_by": null, "required": 12, "prereq": "3a", "selected": 0, "img":"chorddisruption", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4b": {"abil_name": "Echos of the Ancestors, Divine", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"echoesexaltedangel", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4c": { "abil_name": "Echos of the Ancestors, Martial", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"echoeslegendarydreadnaught", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4d": {  "abil_name": "Echos of the Ancestors, Primal", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"echoeswildhunter", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4e": {"abil_name": "Charisma or Strength", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  ...
  "5b": {"abil_name": "Fragment of Song: Clarity", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"fragmentclarity", "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "5c": {"abil_name": "Masquerade", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"masquerade", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
      "1": "Activate masquerade to switch your twist of fate at a rest shrine."
    }
  },
  "5d": {"abil_name": "Fragment of the Song: Valor", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"fragmentvalor", "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "5e": {"abil_name": "Charisma or Strength", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  "6a": {"abil_name": "Grim Fate", "required_by": null, "required": 20, "prereq": "5a", "selected": 0, "img":"grimfate", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "6b": null,
  "6c": {"abil_name": "Turn of the Tide", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"turnofthetide", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6d": null,
  "6e": {"abil_name": "Charisma or Strength", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  }
}
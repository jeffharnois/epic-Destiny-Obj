{
  ...
  "name": "Fatesinger",
  "autogrants": [
      {"abil_name":"Fatesinger&rsquo;s Repertoire", "img":"fatesingersrepertoire-taken", "abil": "(0 required) For every level of Fatesinger, gain 2 Songs, +3 sonic resistance and 25 Spell Points. If you didn&rsquo;t have inspire courage gain that feat. You also gain +1 effective Arcane caster level.", "passive": false},
      {"abil_name":"Glitter of Fame", "img":"glitteroffame-taken", "abil": "(4 required) Gain +1 to your effective Arcane caster level and a +1 to hit. Special Effect: As long as you are above 10% Health, you radiate confidence: gain a +1 to all Ability scores.", "passive": "passive"},
      {"abil_name":"Harmonic Resonance", "img":"harmonicresonance-taken", "abil": "(8 required) Special Effect: Your melee and missile attacks have a 10% chance per hit of building a stacking resonance in your enemies. Each stack increases the creature&rsquo;s vulnerability to Sonic damage by 10%. The effect may stack up to 5 times. and lasts up to 20 seconds [Active]: You may expend a Song to activate Harmonic Resonance. If you do so, your voice thrums with magic, and you no longer require material components to cast spells.", "passive": false},
      {"abil_name":"Intoxicationg Presence", "img":"intoxicatingpresence-taken", "abil": "(12 required) Gain +1 to your effective Arcane caster level and a +1 to hit. Special Effect: As long as you are above 10% Health, enemies that strike you have a 5% chance of becoming Fascinated for 12 seconds, with no saving throw.", "passive": "passive"},
      {"abil_name":"Grandeur", "img":"grandeur-taken", "abil": "(16 required) Gain +1 to your effective Arcane caster level. Special Effect: As long as you are above 10% Health, you project an Aura of Grandeur. This aura grants you and your friends a +1 to all saving throws, a +2 to all Charisma-based skills, and a +3 Unique bonus to damage.", "passive": "passive"},
      {"abil_name":"Majesty", "img":"majesty", "abil": "(20 required) Passive: +1 to your effective Arcane caster level and a +1 to hit. You also gain +5 to all saving throws vs enchantments, a +2 to the effective level of your Enchantment/Charm spells and a +10 to the Spell Power of your Sonic, Light and Positive spells. Special Effect: Enemies that strike you also have a 5% chance to become blinded by your glory (in addition to other effects), with no saving throw.", "passive": "passive"}
  ],
  "1a": {"abil_name": "O Fortuna", "required": 0, "prereq": null, "selected": 0, "img":"ofortuna", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1b": {"abil_name": "Allure", "required": 0, "prereq": null, "selected": 0, "img":"allure", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Music of the Spider Queen", "required": 0, "prereq": null, "selected": 0, "img":"musicspiderqueen", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
      "1": "Fascinate can mesmerize vermin. Vermin still cannot be suggested. "
    }
  },
  "1d": {"abil_name": "Dirge", "required": 0, "prereq": null, "selected": 0, "img":"revielle", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1e": {"abil_name": "Charisma or Strength", "required": 0, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "2c": {"abil_name": "Masked Ball", "required": 4, "prereq": null, "selected": 0, "img":"maskedball", "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "2d": null,
  "2e": {"abil_name": "Charisma or Strength", "required": 4, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  "3a": {"abil_name": "Siren&rsquo;s Song", "required": 8, "prereq": null, "selected": 0, "img":"sirenssong", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3b": {"abil_name": "Reign", "required": 8, "prereq": null, "selected": 0, "img":"artfulmisdirection", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3c": {"abil_name": "Echos of the Ancestors, Arcane", "required": 8, "prereq": null, "selected": 0, "img":"echoesmagister", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3d": {"abil_name": "Aria", "required": 8, "prereq": null, "selected": 0, "img":"ventriloquism", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3e": {"abil_name": "Charisma or Strength", "required": 8, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  ...
  "4b": {"abil_name": "Echos of the Ancestors, Divine", "required": 12, "prereq": null, "selected": 0, "img":"echoesexaltedangel", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4c": { "abil_name": "Echos of the Ancestors, Martial", "required": 12, "prereq": null, "selected": 0, "img":"echoeslegendarydreadnaught", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4d": {  "abil_name": "Echos of the Ancestors, Primal", "required": 12, "prereq": null, "selected": 0, "img":"echoeswildhunter", "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4e": {"abil_name": "Charisma or Strength", "required": 12, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  "5a": {"abil_name": "Bound Fate", "required": 16, "prereq": null, "selected": 0, "img":"boundfate", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "5b": {"abil_name": "Fragment of Song: Clarity", "required": 16, "prereq": null, "selected": 0, "img":"fragmentclarity", "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "5c": {"abil_name": "Masquerade", "required": 16, "prereq": null, "selected": 0, "img":"masquerade", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
      "1": "Activate masquerade to switch your twist of fate at a rest shrine."
    }
  },
  "5d": {"abil_name": "Fragment of the Song: Valor", "required": 16, "prereq": null, "selected": 0, "img":"fragmentvalor", "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "5e": {"abil_name": "Charisma or Strength", "required": 16, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  ...
  "6b": null,
  "6c": {"abil_name": "Turn of the Tide", "required": 20, "prereq": null, "selected": 0, "img":"turnofthetide", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6d": null,
  "6e": {"abil_name": "Charisma or Strength", "required": 20, "prereq": null, "selected": 0, "img":"strcha", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  }
}
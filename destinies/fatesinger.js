{
  ...
  "1b": {"abil_name": "Allure", "required": 0, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Music of the Spider Queen", "required": 0, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 1, "abil": {
      "1": "Fascinate can mesmerize vermin. Vermin still cannot be suggested. "
    }
  },
  "1d": {"abil_name": "Dirge", "required": 0, "prereq": null, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1e": {"abil_name": "Charisma or Strength", "required": 0, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  "2a": {"abil_name": "Tailwind", "required": 4, "prereq": [{"req": "1a", "tier": 1}], "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2b": {"abil_name": "Lucidity", "required": 4, "prereq": [{"req": "1b", "tier": 1}], "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2c": {"abil_name": "Masked Ball", "required": 4, "prereq": [{"req": "1c", "tier": 1}], "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "2d": null,
  "2e": {"abil_name": "Charisma or Strength", "required": 0, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  "3a": {"abil_name": "Siren&rsquo;s Song", "required": 8, "prereq": null, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3b": {"abil_name": "Reign", "required": 8, "prereq": [{"req": "1b", "tier": 1}], "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3c": {"abil_name": "Echos of the Ancestors, Arcane", "required": 8, "prereq": null, "multi": "multi", "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3d": {"abil_name": "Aria", "required": 8, "prereq": [{"req": "1d", "tier": 1}], "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3e": {"abil_name": "Charisma or Strength", "required": 0, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  "4a": {"abil_name": "Chord of Disruption", "required": 12, "prereq": [{"req": "3a", "tier": 1}], "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4b": {"abil_name": "Echos of the Ancestors, Divine", "required": 12, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "4c": { "abil_name": "Echos of the Ancestors, Martial", "required": 12, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "4d": {  "abil_name": "Echos of the Ancestors, Primal", "required": 12, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4e": {"abil_name": "Charisma or Strength", "required": 0, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  ...
  "5b": {"abil_name": "Fragment of Song: Clarity", "required": 16, "prereq": null, "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "5c": {"abil_name": "Masquerade", "required": 16, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 1, "abil": {
      "1": "Activate masquerade to switch your twist of fate at a rest shrine."
    }
  },
  "5d": {"abil_name": "Fragment of the Song: Valor", "required": 16, "prereq": null, "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "5e": {"abil_name": "Charisma or Strength", "required": 0, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  },
  "6a": {"abil_name": "Grim Fate", "required": 20, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "6b": null,
  "6c": {"abil_name": "Turn of the Tide", "required": 20, "prereq": null, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "6d": null,
  "6e": {"abil_name": "Charisma or Strength", "required": 0, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Charisma", "2": "+1 Strength"}
    }
  }
}
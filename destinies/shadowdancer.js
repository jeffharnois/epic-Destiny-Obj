{
  ...
  "1a": {"abil_name": "Stealthy", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"stealthy", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1b": {"abil_name": "Shadow Lance", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"shadowlance", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Acrobatic", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"acrobatic", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1e": {"abil_name": "Dexterity or Intelligence", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"dexint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  "2a": {"abil_name": "Escape", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"escapenotice", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": "(Cooldown: 1min) Triggers a Diplomacy effect that uses the hide skill instead of the diplomacy skill."
    }
  },
  "2b": null,
  "2c": {"abil_name": "Lithe", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"lithe", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2d": {"abil_name": "Skill Mastery", "required_by": null, "required": 4, "prereq": "1d", "selected": 0, "img":"skillmastery", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
      "1": "+1 stacking to all skills. "
    }
  },
  "2e": {"abil_name": "Dexterity or Intelligence", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"dexint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  "3a": {"abil_name": "Cloak of Shadows", "required_by": null, "required": 8, "prereq": "3b", "selected": 0, "img":"cloakofshadows", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3c": {"abil_name": "Meld Into Darkness", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"meldintoshadow", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3e": {"abil_name": "Dexterity or Intelligence", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"dexint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  "4a": null,
  ...
  "4c": null,
  "4d": {"abil_name": "Pierce the Gloom", "required_by": null, "required": 12, "prereq": "3d", "selected": 0, "img":"piercethegloom", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": "(Cooldown: 2min) Gain +100% to your attack bonus for 30 seconds."
    }
  },
  "4e": {"abil_name": "Dexterity or Intelligence", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"dexint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  ...
  "5c": {"abil_name": "Executioner&rsquo;s Strike/Shot", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"executionersstrike", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "5d": {"abil_name": "Sealed Soul", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"sealedsoul", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": "Grant you immunity to energy drain "
    }
  },
  "5e": {"abil_name": "Dexterity or Intelligence", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"dexint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  "6a": {"abil_name": "Consume", "required_by": null, "required": 20, "prereq": "5a", "selected": 0, "img":"consume", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6c": {"abil_name": "Dark Imbuement", "required_by": null, "required": 20, "prereq": "6b", "selected": 0, "img":"darkimbuement", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6d": null,
  "6e": {"abil_name": "Dexterity or Intelligence", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"dexint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  }
}
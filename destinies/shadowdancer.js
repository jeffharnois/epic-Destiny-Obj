{
  "dID": "shadowdancer",
  "name": "Shadowdancer",
  "1a": {"abil_name": "Stealthy", "required": 0, "prereq": null, "selected": 0, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1b": {"abil_name": "Shadow Lance", "required": 0, "prereq": null, "selected": 0, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Acrobatic", "required": 0, "prereq": null, "selected": 0, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1d": {"abil_name": "Technician", "required": 0, "prereq": null, "selected": 0, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1e": {"abil_name": "Dexterity or Intelligence", "required": 0, "prereq": null, "selected": 0, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  "2a": {"abil_name": "Escape", "required": 4, "prereq": null, "selected": 0, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": "(Cooldown: 1min) Triggers a Diplomacy effect that uses the hide skill instead of the diplomacy skill."
    }
  },
  "2b": null,
  "2c": {"abil_name": "Lithe", "required": 4, "prereq": null, "selected": 0, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2d": {"abil_name": "Skill Mastery", "required": 4, "prereq": [{"req": "1d", "tier": 1}], "selected": 0, "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
      "1": "+1 stacking to all skills. "
    }
  },
  "2e": {"abil_name": "Dexterity or Intelligence", "required": 4, "prereq": null, "selected": 0, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  "3a": {"abil_name": "Cloak of Shadows", "required": 8, "prereq": [{"req": "3b", "tier": 1}], "selected": 0, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3b": {"abil_name": "Shrouding Strike/Shot", "required": 8, "prereq": null, "selected": 0, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3c": {"abil_name": "Meld Into Darkness", "required": 8, "prereq": null, "selected": 0, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
      "1": "(Cooldown: 2min) +100% Enhancement bonus to dodge for 6 seconds.", 
      "2": "",
      "3": ""
    }
  },
  "3d": {"abil_name": "Grim Precision", "required": 8, "prereq": null, "selected": 0, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3e": {"abil_name": "Dexterity or Intelligence", "required": 8, "prereq": null, "selected": 0, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  "4a": null,
  "4b": {"abil_name": "Improved Invisibility", "required": 12, "prereq": [{"req": "3b", "tier": 1}], "selected": 0, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "4c": null,
  "4d": {"abil_name": "Pierce the Gloom", "required": 12, "prereq": [{"req": "3d", "tier": 1}], "selected": 0, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": "(Cooldown: 2min) Gain +100% to your attack bonus for 30 seconds."
    }
  },
  "4e": {"abil_name": "Dexterity or Intelligence", "required": 12, "prereq": null, "selected": 0, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  "5a": {"abil_name": "Shadow Manipulation", "required": 16, "prereq": [{"req": "3a", "tier": 1}], "selected": 0, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "5b": {"abil_name": "Untouchable", "required": 16, "prereq": [{"req": "4b", "tier": 1}], "selected": 0, "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
      "1": "Gain 1% extra dodge for each Shadow Charge you hold. "
    }
  },
  "5c": {"abil_name": "Executioner&rsquo;s Strike/Shot", "required": 16, "prereq": null, "selected": 0, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "5d": {"abil_name": "Sealed Soul", "required": 16, "prereq": null, "selected": 0, "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": "Grant you immunity to energy drain "
    }
  },
  "5e": {"abil_name": "Dexterity or Intelligence", "required": 16, "prereq": null, "selected": 0, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  },
  ...
  "6d": null,
  "6e": {"abil_name": "Dexterity or Intelligence", "required": 20, "prereq": null, "selected": 0, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Dexterity", "2": "+1 Intelligence"}
    }
  }
}
{
  ...
  "1b": {"abil_name": "Endless Turning", "required": 0, "prereq": null, "selected": 0, "img":"endlessturning", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Brace for Impact", "required": 0, "prereq": null, "selected": 0, "img":"braceforimpact", "multi": false, "passive": "passive", "ranks": 2, "AP": 2, "abil": {
  ...
  "1e": {"abil_name": "Constitution or Charisma", "required": 0, "prereq": null, "selected": 0, "img":"chacon", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  "2a": {"abil_name": "Confront Any Foe", "required": 4, "prereq": null, "selected": 0, "img":"confrontanyfoe", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "2b": {"abil_name": "Fanaticism", "required": 4, "prereq": null, "selected": 0, "img":"smitevillainy", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "2c": {"abil_name": "Endless smiting", "required": 4, "prereq": null, "selected": 0, "img":"endlesssmiting", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2e": {"abil_name": "Constitution or Charisma", "required": 4, "prereq": null, "selected": 0, "img":"chacon", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  "3a": {"abil_name": "Block Energy", "required": 8, "prereq": null, "selected": 0, "img":"shieldagainstenergy", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3b": {"abil_name": "Intolerant Blow", "required": 8, "prereq": null, "selected": 0, "img":"abidenoevil", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3c": {"abil_name": "Healing Hands", "required": 8, "prereq": null, "selected": 0, "img":"healinghands", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": "You gain the Lay on Hands feat. You gain +25 positive spellpower."
    }
  },
  "3d": {"abil_name": "Endless Lay on Hands", "required": 8, "prereq": null, "selected": 0, "img":"endlesslayonhands", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3e": {"abil_name": "Constitution or Charisma", "required": 8, "prereq": null, "selected": 0, "img":"chacon", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  "4a": null,
  "4b": {"abil_name": "Spark of Life", "required": 12, "prereq": null, "selected": 0, "img":"sparkoflifeeternal", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": "Your armor gains Deathblock, protecting you from death effects "
    }
  },
  "4c": {"abil_name": "Light the Dark", "required": 12, "prereq": null, "selected": 0, "img":"lightthedarkness", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4d": {"abil_name": "Purify Weapon", "required": 12, "prereq": null, "selected": 0, "img":"purifyweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": "While you Stand Against the Tide, weapons you equip gain pure good, dealing 1d6 damage vs. non good targets."
    }
  },
  "4e": {"abil_name": "Constitution or Charisma", "required": 12, "prereq": null, "selected": 0, "img":"chacon", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  ...
  "5e": {"abil_name": "Constitution or Charisma", "required": 16, "prereq": null, "selected": 0, "img":"chacon", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  "6a": null,
  ...
  "6d": null,
  "6e": {"abil_name": "Constitution or Charisma", "required": 20, "prereq": null, "selected": 0, "img":"chacon", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  }
}
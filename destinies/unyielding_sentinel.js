{
  ...
  "1b": {"abil_name": "Endless Turning", "required": 0, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Brace for Impact", "required": 0, "prereq": null, "multi": false, "passive": "passive", "ranks": 2, "AP": 2, "abil": {
      "1": "+20% fortification. +1 reflex/fort/will saves", 
      "2": "+40% fortification. +2 reflex/fort/will saves"
    }
  },
  "1d": {"abil_name": "Shield Prowess", "required": 0, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "Shield AC contribution increased by 15% ", 
      "2": "",
      "3": "Shield AC contribution increased by 50%"
    }
  },
  "1e": {"abil_name": "Constitution or Charisma", "required": 0, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  "2a": {"abil_name": "Confront Any Foe", "required": 4, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "2b": {"abil_name": "Fanaticism", "required": 4, "prereq": null, "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "2c": {"abil_name": "Endless smiting", "required": 4, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2d": {"abil_name": "Legendary Shield Mastery", "required": 4, "prereq": [{"req": "1d", "tier": 1}], "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2e": {"abil_name": "Constitution or Charisma", "required": 4, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  "3a": {"abil_name": "Block Energy", "required": 8, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3b": {"abil_name": "Intolerant Blow", "required": 8, "prereq": null, "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "3c": {"abil_name": "Healing Hands", "required": 8, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": "You gain the Lay on Hands feat. You gain +25 positive spellpower."
    }
  },
  "3d": {"abil_name": "Endless Lay on Hands", "required": 8, "prereq": null, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3e": {"abil_name": "Constitution or Charisma", "required": 8, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  "4a": null,
  "4b": {"abil_name": "Spark of Life", "required": 12, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": "Your armor gains Deathblock, protecting you from death effects "
    }
  },
  "4c": {"abil_name": "Light the Dark", "required": 12, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "4d": {"abil_name": "Purify Weapon", "required": 12, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": "While you Stand Against the Tide, weapons you equip gain pure good, dealing 1d6 damage vs. non good targets."
    }
  },
  "4e": {"abil_name": "Constitution or Charisma", "required": 12, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  "5a": {"abil_name": "Hardened", "required": 16, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "", 
      "2": "",
      "3": ""
    }
  ...
  "5b": null,
  "5c": {"abil_name": "Ward Against Evil", "required": 16, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "When you are hit or miss by evil attackers, you have 20% chance to deal 3d6.", 
      "2": "",
      "3": ""
    }
  },
  "5d": {"abil_name": "Anoint weapon", "required": 16, "prereq": [{"req": "4d", "tier": 1}, {"req": "5c", "tier": 1}], "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "5e": {"abil_name": "Constitution or Charisma", "required": 16, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  },
  "6a": null,
  "6b": null,
  "6c": {"abil_name": "Undying Vanguard", "required": 20, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6d": null,
  "6e": {"abil_name": "Constitution or Charisma", "required": 20, "prereq": null, "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Constitution", "2": "+1 Charisma"}
    }
  }
}
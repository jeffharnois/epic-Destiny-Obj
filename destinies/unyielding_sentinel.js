{
    ...
    "autogrants": [
        {
            "abil_name": "Vigor of Battle",
            "img": "vigorofbattle",
            "abil": "+50 hp. Sentinel stance (Active Cooldown: 20secs): 10% healing amp and +50 hp. Enemies you hit gain healing touch for 3 seconds: grants 10 temporary HP to targets they attack.",
            "passive": false
        },
        {
            "abil_name": "Unbreakable",
            "img": "unbreakable-taken",
            "abil": "(level 1) +5 sacred bonus to natural armor. You gain the diehard feat. Sentinel stance (Active Cooldown: 20secs): you gain DR 10/epic",
            "passive": false
        },
        {
            "abil_name": "Stand Against the Tide",
            "img": "standagainstthetide-taken",
            "abil": "(level 2) +2 Attack. Sentinel stance (Active Cooldown: 20secs) : +1 melee damage, 20% threat generation, 5% fort, +1 reflex/fort/will saves. These bonuses increases while standing still, up to 4 times.",
            "passive": false
        },
        {
            "abil_name": "Stalwart Guardian",
            "img": "stalwartguardian-taken",
            "abil": "(level 3) +50 hp. +50 additional hp while in Vigor of Battle stance.",
            "passive": "passive"
        },
        {
            "abil_name": "Heed No Pain",
            "img": "shrugoff",
            "abil": "(level 4) +10 physical resistance. +20 additional physical resistance while in Unbreakable stance.",
            "passive": "passive"
        },
        {
            "abil_name": "Steadfast",
            "img": "untouchable",
            "abil": "(level 5) +1damage. +1 bonus to reflex/fort/will saves. Can&rsquo;t be knocked down in Stand Against the Tide stance.",
            "passive": "passive"
        }
    ],
    "1a": {
        "abil_name": "Divine Energy Resistance",
        "required_by": null,
        "required": 0,
        "prereq": null,
        "selected": 0,
        "img": "divineenergyresistance",
        "multi": false,
        "passive": "passive",
        "ranks": 3,
        "AP": 1,
    ...
    "1b": {
        "abil_name": "Commanding Presence",
        "required_by": null,
        "required": 0,
        "prereq": null,
        "selected": 0,
        "img": "commandingpresence",
        "multi": false,
        "passive": "passive",
        "ranks": 3,
        "AP": 1,
    ...
    "1e": {
        "abil_name": "Constitution or Charisma",
        "required_by": null,
        "required": 0,
        "prereq": null,
        "selected": 0,
    ...
    "2d": {
        "abil_name": "Legendary Shield Mastery",
        "required_by": null,
        "required": 4,
        "prereq": "1d",
        "selected": 0,
    ...
    "3d": {
        "abil_name": "Endless Lay on Hands",
        "required_by": null,
        "required": 8,
        "prereq": null,
        "selected": 0,
    ...
    "5b": {
        "abil_name": "Strength of Vitality",
        "required_by": null,
        "required": 16,
        "prereq": null,
        "selected": 0,
        "img": "strengthofvitality",
        "multi": false,
        "passive": "passive",
        "ranks": 3,
        "AP": 1,
    ...
    "6a": {
        ...
        "AP": 2,
        "abil": {
            "1": "Metamgic: Quicken, Eschew Materials, Enlarge.  Spell Resistance: No.  Activation Cost: 15 Spell Points.  Cooldown: 6 seconds.  Resurrects the target, restores half of the target&rsquo;s hitpoints, and preserves current spell points."
        }
    },
    "6b": null,
    "6c": {
        "abil_name": "Undying Vanguard",
        "required_by": null,
        "required": 20,
        "prereq": null,
        "selected": 0,

{
  1a: {abil_name: "Sigil of Warding", required: 0, prereq: null, multi: false, passive: false, ranks: 3, AP: 1, abil: {
      1: "(Cooldown: 30 secs) Inscribes a sigil for 60 seconds. Grants 1DR/- and 5 PRR. Only one sigil active per caster.", 
      2: "(Cooldown: 30 secs) Inscribes a sigil for 60 seconds. Grants 2DR/- and 10 PRR. Only one sigil active per caster.",
      3: "(Cooldown: 30 secs) Inscribes a sigil for 60 seconds. Grants 3DR/- and 15 PRR. Only one sigil active per caster."
    }
  },
  ...
  1c: {abil_name: "Unearthly Reactions", required: 0, prereq: null, multi: false, passive: true, ranks: 3, AP: 1, abil: {
      1: "+1 dodge, +2 reflex", 
      2: "+2 dodge, +4 reflex",
      3: "+3 dodge, +6 reflex"
    }
  },
  1d: {abil_name: "Impregnable Mind", required: 0, prereq: null, multi: false, passive: true, ranks: 3, AP: 1, abil: {
  ...
  2c: null,
  2d: {abil_name: "Spell School Specialist", required: 4, prereq: null, multi: true, passive: true, ranks: 3, AP: 1, abil: {
  ...
  3b: {abil_name: "Variable Resistance", required: 8, prereq: [{req: "3a", tier: 1}], multi: false, passive: true, ranks: 3, AP: 1, abil: {
  ...
  3c: {abil_name: "Piercing Spellcraft", required: 8, prereq: null, multi: false, passive: true, ranks: 3, AP: 1, abil: {
      1: "+1 to spell penetration", 
      2: "+2 to spell penetration",
      3: "+3 to spell penetration"
    }
  },
  3d: {abil_name: "Spell School Augmentation", required: 8, prereq: [{req: "2d", tier: 1}], multi: false, passive: true, ranks: 3, AP: 1, abil: {
  ...
  4b: {abil_name: "Nullmagic Guard", required: 12, prereq: null, multi: false, passive: true, ranks: 3, AP: 1, abil: {
  ...
  4d: {abil_name: "Spell School Familiarity", required: 12, prereq: [{req: "3d", tier: "1"}], multi: false, passive: true, ranks: 3, AP: 1, abil: {
  ...
  5a: null,
  5b: {abil_name: "Nullmagic Strike", required: 16, prereq: [{req: "4b", tier: 1}], multi: false, passive: true, ranks: 3, AP: 1, abil: {
  ...
  5c: {abil_name: "Grand Summoner", required: 16, prereq: [{req: "4c", tier: 1}], multi: false, passive: true, ranks: 1, AP: 1, abil: {
  ...
  5d: {abil_name: "Spell School Mastery", required: 16, prereq: [{req: "4d", tier: 1}], multi: false, passive: true, ranks: 3, AP: 1, abil: {
  ...
  6c: null,
  6d: {abil_name: "Arcane Adept", required: 20, prereq: null, multi: false, passive: true, ranks: 1, AP: 2, abil: {

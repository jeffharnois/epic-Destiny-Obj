{
  ...
  "autogrants": [
      ...
      {"abil_name":"Arcane Study III", "img":"arcanestudy_iii", "abil": "(level 2) +50 SP +1 caster level to all arcane spell", "passive": "passive"},
      {"abil_name":"Arcane Study IV", "img":"arcanestudy_iv", "abil": "(level 3) +50 SP +1 caster level to all arcane spell", "passive": "passive"},
      {"abil_name":"Arcane Study V", "img":"arcanestudy_v", "abil": "(level 4) +50 SP +1 caster level to all arcane spell", "passive": "passive"},
  ...
  "1a": {"abil_name": "Sigil of Warding", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"sigil_spellwarding", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1b": {"abil_name": "Imperceptible Casting", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"imperceptiblecasting", "multi": false, "passive": false, "ranks": 1, "AP": 1, "abil": {
      "1": "(Cooldown: 1min) For the next 10 seconds spell threat is reduced to 5% of its normal amount "
    }
  },
  "1c": {"abil_name": "Unearthly Reactions", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"unearthlyreactions", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "+1 dodge, +2 reflex", 
      "2": "+2 dodge, +4 reflex",
      "3": "+3 dodge, +6 reflex.  When you tumble, you will phase out from reality briefly, passing through enemies as you do so."
    }
  },
  "1d": {"abil_name": "Impregnable Mind", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"impregnablemind", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1e": {"abil_name": "Intelligence or Charisma", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"chaint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Intelligence", "2": "+1 Charisma"}
    }
  },
  "2a": {"abil_name": "Sigil of Lifeshielding", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"sigil_lifeshielding", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "2b": {"abil_name": "Fade Into the Weave", "required_by": null, "required": 4, "prereq": "1b", "selected": 0, "img":"fadeintotheweave", "multi": false, "passive": false, "ranks": 1, "AP": 1, "abil": {
  ...
  "2c": null,
  "2d": {"abil_name": "Spell School Specialist", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"specialist_school", "multi": "multi", "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2e": {"abil_name": "Intelligence or Charisma", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"chaint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Intelligence", "2": "+1 Charisma"}
    }
  },
  "3a": {"abil_name": "Sigil of Energy Negation", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"sigil_energynegation", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "3b": {"abil_name": "Variable Resistance", "required_by": null, "required": 8, "prereq": "3a", "selected": 0, "img":"variableresistance", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3d": {"abil_name": "Spell School Augmentation", "required_by": null, "required": 8, "prereq": "2d", "selected": 0, "img":"augmentation_school", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3e": {"abil_name": "Intelligence or Charisma", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"chaint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Intelligence", "2": "+1 Charisma"}
    }
  },
  "4a": {"abil_name": "Sigil of Battering Spellcraft", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"sigil_batteringspellcraft", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "4b": {"abil_name": "Nullmagic Guard", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"nullmagic_guard", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4c": {"abil_name": "Call Kindred Being", "required_by": null, "required": 12, "prereq": "4d", "selected": 0, "img":"summon_school", "multi": false, "passive": false, "ranks": 1, "AP": 1, "abil": {
  ...
  "4d": {"abil_name": "Spell School Familiarity", "required_by": null, "required": 12, "prereq": "3d", "selected": 0, "img":"familiarity_school", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4e": {"abil_name": "Intelligence or Charisma", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"chaint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Intelligence", "2": "+1 Charisma"}
    }
  },
  "5a": null,
  "5b": {"abil_name": "Nullmagic Strike", "required_by": null, "required": 16, "prereq": "4b", "selected": 0, "img":"nullmagic_strike", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "5c": {"abil_name": "Grand Summoner", "required_by": null, "required": 16, "prereq": "4c", "selected": 0, "img":"grandsummoner", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
  ...
  "5d": {"abil_name": "Spell School Mastery", "required_by": null, "required": 16, "prereq": "4d", "selected": 0, "img":"master_school", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "5e": {"abil_name": "Intelligence or Charisma", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"chaint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Intelligence", "2": "+1 Charisma"}
    }
  },
  "6a": {"abil_name": "Arcane Tempest", "required_by": null, "required": 20, "prereq": "4a", "selected": 0, "img":"arcanetempest", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
      "1": "(Cooldown: 3mins) AoE that deals 2d6 damage per caster level each 2 seconds for 8 seconds.  (Reflex save)."
    }
  },
  "6b": {"abil_name": "Nullmagic Aura", "required_by": null, "required": 20, "prereq": "5b", "selected": 0, "img":"nullmagic_aura", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6c": null,
  "6d": {"abil_name": "Arcane Adept", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"arcaneadept", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": "All spells can be cast with 10% fewer spell points"
    }
  },
  "6e": {"abil_name": "Intelligence or Charisma", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"chaint", "multi": "multi", "passive": "passive", "ranks": 1, "AP": 2, "abil": {
      "1": {"1": "+1 Intelligence", "2": "+1 Charisma"}
    }
  }
}
{
  ...
  "1a": {"abil_name": "Energy Sheath", "required_by": ["2a"], "required": 0, "prereq": null, "selected": 0, "img":"energysheath_fire", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1b": {"abil_name": "Draconic Presence", "required_by": ["3b"], "required": 0, "prereq": null, "selected": 0, "img":"draconicpresence", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Dragonhide", "required_by": ["2c"], "required": 0, "prereq": null, "selected": 0, "img":"dragonhide", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1d": {"abil_name": "Draconic Perception", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"perception", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2a": {"abil_name": "Go Out With A Bang", "required_by": ["4a"], "required": 4, "prereq": "1a", "selected": 0, "img":"gooutwithabang_fire", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "2b": null,
  "2c": {"abil_name": "Barrier of Scales", "required_by": null, "required": 4, "prereq": "1c", "selected": 0, "img":"barrierofscales", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "2d": {"abil_name": "Precise Casting", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"precise_casting", "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "3a": null,
  "3b": {"abil_name": "Daunting Roar", "required_by": null, "required": 8, "prereq": "1b", "selected": 0, "img":"dauntingroar", "multi": false, "passive": false, "ranks": 1, "AP": 1, "abil": {
  ...
  "3c": {"abil_name": "Dragon Heritage", "required_by": ["4c"], "required": 8, "prereq": null, "selected": 0, "img":"heritage_red", "multi": false, "passive": "passive", "ranks": "3", "AP": 1, "abil": {
  ...
  "3d": {"abil_name": "Piercing Spellcraft", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"piercingspellcraft", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4a": {"abil_name": "Energy Burst", "required_by": ["6a"], "required": 12, "prereq": "2a", "selected": 0, "img":"energyburst_fire", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "4b": {"abil_name": "Secondary Spell Speciality", "required_by": null, "required": 12, "prereq": "4c", "selected": 0, "img":"spellpower_red", "multi": false, "passive": "passive", "ranks": 2, "AP": 1, "abil": {
  ...
  "4c": {"abil_name": "Draconic Spell Knowledge", "required_by": ["4b","4d", "5c"], "required": 12, "prereq": "3c", "selected": 0, "img":"spellpower_red", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4d": {"abil_name": "Draconic Spell Augmentation", "required_by": null, "required": 12, "prereq": "4c", "selected": 0, "img":"spellaugment_fire", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "5a": null,
  "5b": {"abil_name": "Flyby Attack", "required_by": null, "required": 16, "prereq": "5c", "selected": 0, "img":"flyby_fire", "multi": false, "passive": false, "ranks": 1, "AP": 1, "abil": {
  ...
  "5c": {"abil_name": "Dragon Breath", "required_by": ["5b","5d"], "required": 16, "prereq": "4c", "selected": 0, "img":"breath_red", "multi": false, "passive": false, "ranks": 1, "AP": 1, "abil": {
      "1": "Cooldown: 1min) Cone that deals 60d6 [fire/cold/electric/acid] damage (reflex save for half). Can use 5 times per rest."
    }
  },
  "5d": {"abil_name": "Draconic Breath Augmentation", "required_by": null, "required": 16, "prereq": "5c", "selected": 0, "img":"breathaugment_fire", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
  ...
  "6a": {"abil_name": "Energy Vortex", "required_by": null, "required": 20, "prereq": "4a", "selected": 0, "img":"energyvortex_fire", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6b": {"abil_name": "Draconic Hunger", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"hunger", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "6c": {"abil_name": "Fearsome Invulnerability", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"fearsomeinvuln", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {

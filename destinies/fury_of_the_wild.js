{
  ...
  "1a": {"abil_name": "Tunnel Vision", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"indomitablewill", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "1b": {"abil_name": "Primal Scream", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"primalscream", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Boulder Toss", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"bouldertoss", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1d": {"abil_name": "Fast Healing", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"fasthealing", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2b": {"abil_name": "Unstoppable Fury", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"unstoppablefury", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2d": {"abil_name": "Damage Reduction", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"damagereduction", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3a": {"abil_name": "Insult", "required_by": null, "required": 8, "prereq": "2a", "selected": 0, "img":"insult", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3c": null,
  "3d": {"abil_name": "Ward against Weird", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"occultwards", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4a": {"abil_name": "Gird Against Demons", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"girdagainstdemons", "multi": false, "passive": "passive", "ranks": 2, "AP": 2, "abil": {
  ...
  "4b": {"abil_name": "Wild Weapons", "required_by": null, "required": 12, "prereq": "3b", "selected": 0, "img":"wildweapons", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "+3% glancing blow damage.", 
      "2": "+6% glancing blow damage.",
      "3": "+9% glancing blow damage."
    }
  },
  "4c": {"abil_name": "Sense Weakness", "required_by": null, "required": 12, "prereq": "2c", "selected": 0, "img":"senseweakness", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4d": {"abil_name": "Overwhelming Force", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"overwhelmingforce", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "5a": null,
  "5b": {"abil_name": "Fury Made Placid", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"furymadeplacid", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "5c": {"abil_name": "Fury Eternal", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"furyeternal", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "6a": null,
  "6b": null,
  "6c": {"abil_name": "Unbridled Fury", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"unbridledfury", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {

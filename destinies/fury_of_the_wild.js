{
  ...
  "1b": {"abil_name": "Primal Scream", "required": 0, "prereq": null, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1c": {"abil_name": "Boulder Toss", "required": 0, "prereq": null, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "1d": {"abil_name": "Fast Healing", "required": 0, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2a": {"abil_name": "Injury", "required": 4, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "While you are injured, enemies you damage in melee are shaken.", 
      "2": "",
      "3": ""
    }
  },
  "2b": {"abil_name": "Unstoppable Fury", "required": 4, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "While raged, when you miss with a melee attack, gain +1 attack for 20s. Can stack 3 times. Only loses 1 stack each 20s.", 
      "2": "",
      "3": ""
    }
  },
  "2c": {"abil_name": "Acute Instincts", "required": 4, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "2d": {"abil_name": "Damage Reduction", "required": 4, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3a": {"abil_name": "Insult", "required": 8, "prereq": [{"req": "2a", "tier": 1}], "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3b": {"abil_name": "Malicious Weapons", "required": 8, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "3c": null,
  "3d": {"abil_name": "Ward against Weird", "required": 8, "prereq": null, "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4a": {"abil_name": "Gird Against Demons", "required": 12, "prereq": null, "multi": false, "passive": "passive", "ranks": 2, "AP": 2, "abil": {
  ...
  "4b": {"abil_name": "Wild Weapons", "required": 12, "prereq": [{"req": "3b", "tier": 1}], "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "+3% glancing blow damage.", 
      "2": "+6% glancing blow damage.",
      "3": "+9% glancing blow damage."
    }
  },
  "4c": {"abil_name": "Sense Weakness", "required": 12, "prereq": [{"req": "2c", "tier": 1}], "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
  ...
  "4d": {"abil_name": "Overwhelming Force", "required": 12, "prereq": null, "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "5a": null,
  "5b": {"abil_name": "Fury Made Placid", "required": 16, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "5c": {"abil_name": "Fury Eternal", "required": 16, "prereq": null, "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "6a": null,
  "6b": null,
  "6c": {"abil_name": "Unbridled Fury", "required": 20, "prereq": null, "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {

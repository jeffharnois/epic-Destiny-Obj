{
  ...
  "points_spent": 0,
  "autogrants": [
      {"abil_name":"Just Cause", "img":"annointweapon-taken", "abil": "You gain Cleric, Favored Soul, and Paladin Caster Levels equal to your level in Divine Crusader..  +25 Spell Points.  +10 Hit Points.  Your Base Attack Bonus is equal to your total Character Level", "passive": "passive"},
      ...
      {"abil_name":"Extraordinary Virtue", "img":"annointweapon-taken", "abil": "(level 2) Passive: +10% Healing Amp, +10 Positive Spell Power, +25 Spell Points, +10 Hit Points", "passive": "passive"},
      {"abil_name":"No Remorse", "img":"annointweapon-taken", "abil": "(level 3) Whenever an enemy who was recently affected by your Aura of Purification is slain, nearby allies are healed for Positive Energy equal to the level of the slain enemy.  Passive:.  +25 Spell Points.  +10 hit points", "passive": "passive"},
      {"abil_name":"Sword of Justice", "img":"annointweapon-taken", "abil": "(level 4) +4 damage with all attacks, +25 Spell points, +10 Hit points", "passive": "passive"},
      {"abil_name":"Zeal of the Righteous", "img":"confrontanyfoe-taken", "abil": "(level 5) Cooldown: 4 minutes.  Activate: Gain 50 stacks of Righteous Zeal.  Righteous Zeal: +1 Spell Power, +1 Doublestrike, +1 Doubleshot, +1% damage with physical attacks.  Decays by 1 stack every 3 seconds, and is not lost when resting.", "passive": false}
  ],
  ...
  "1c": {"abil_name": "Interrogation", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
  ...
  "1d": {"abil_name": "Purge the Wicked", "required_by": null, "required": 0, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
  ...
  "2b": {"abil_name": "Consecration", "required_by": "3b", "required": 4, "prereq": null, "selected": 0, "img":"confrontanyfoe", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "2c": {"abil_name": "Flames of Purity", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 3, "AP": 1, "abil": {
      "1": "Passive: +10 Fire Spell Power",
      "2": "Passive: +20 Fire Spell Power",
      "3": "Passive: +30 Fire Spell Power"
    }
  },
  "2d": {"abil_name": "Smite the Wicked", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "3a": {"abil_name": "Stand and Be Judged", "required_by": null, "required": 4, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
  ...
  "3c": {"abil_name": "Empyrean Magic", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 1, "abil": {
  ...
  "3d": {"abil_name": "Blessed Blades", "required_by": null, "required": 8, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "4a": {"abil_name": "No Regret", "required_by": null, "required": 12, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "4b": {"abil_name": "Crusade", "required_by": null, "required": 12, "prereq": "3b", "selected": 0, "img":"confrontanyfoe", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
  ...
  "5a": {"abil_name": "Castigation", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "5b": {"abil_name": "Heavenly Presence", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "5c": null,
  "5d": {"abil_name": "Celestial Champion", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"annointweapon", "multi": false, "passive": "passive", "ranks": 1, "AP": 2, "abil": {
  ...
  "6a": null,
  "6b": {"abil_name": "Celestial Bombardment", "required_by": null, "required": 16, "prereq": null, "selected": 0, "img":"confrontanyfoe", "multi": false, "passive": false, "ranks": 3, "AP": 1, "abil": {
  ...
  "6c": {"abil_name": "Strike Down", "required_by": null, "required": 20, "prereq": null, "selected": 0, "img":"confrontanyfoe", "multi": false, "passive": false, "ranks": 1, "AP": 2, "abil": {
